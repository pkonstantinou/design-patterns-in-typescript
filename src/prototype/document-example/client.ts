...
// This also modified OROGINAL_DOCUMENT because of the shallow copy
// when using mode 1
...
// This does NOT modify OROGINAL_DOCUMENT because it changes the
...
const DOCUMENT_COPY_4 = DOCUMENT_COPY_3.clone(2); // deep copy
DOCUMENT_COPY_4.name = 'Copy 4';
console.log(DOCUMENT_COPY_4);
DOCUMENT_COPY_4.customMethod();
